...
const u32 gObjectEventPic_Plumeria[] = INCBIN_U32("graphics/object_events/pics/people/plumeria.4bpp");
const u16 gObjectEventPal_Plumeria[] = INCBIN_U16("graphics/object_events/palettes/plumeria.gbapal");