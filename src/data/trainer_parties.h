...
static const struct TrainerMon sParty_Bonnie[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_DIGGERSBY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GUNK_SHOT, MOVE_PAYBACK, MOVE_IRON_HEAD, MOVE_WILD_CHARGE}
    }
};

static const struct TrainerMon sParty_GoldenFreddy[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .isShiny = TRUE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_DARKEST_LARIAT, MOVE_REVENGE, MOVE_PAYBACK}
    }
};

static const struct TrainerMon sParty_Chica[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_BLAZIKEN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRAVE_BIRD, MOVE_CURSE, MOVE_ENDURE, MOVE_FLARE_BLITZ}
    }
};

static const struct TrainerMon sParty_SpringTrap[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 100,
    ...
    .isShiny = TRUE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_FIRE_BLAST, MOVE_IRON_HEAD}
    }
};
...
static const struct TrainerMon sParty_Freddy[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_NIGHT_SLASH, MOVE_SHADOW_CLAW, MOVE_PAYBACK}
    }
};

static const struct TrainerMon sParty_Foxy[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_DELPHOX,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCHOR_SHOT, MOVE_SHADOW_BALL, MOVE_MYSTICAL_FIRE, MOVE_NASTY_PLOT}
    }
};
...
static const struct TrainerMon sParty_Mimi1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIQUIDATION, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_DRACO_METEOR}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .gender = TRAINER_MON_FEMALE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_DRAINING_KISS, MOVE_REFLECT, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .gender = TRAINER_MON_FEMALE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_COLLISION_COURSE, MOVE_FLARE_BLITZ, MOVE_GIGA_IMPACT, MOVE_OUTRAGE}
    }
};
...
static const struct TrainerMon sParty_Heeb1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ELECTRO_BALL, MOVE_SURF, MOVE_THUNDER_WAVE, MOVE_SUPERSONIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_RISING_VOLTAGE, MOVE_QUICK_ATTACK, MOVE_ASTONISH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WILD_CHARGE, MOVE_THUNDER_WAVE, MOVE_ELECTRIC_TERRAIN, MOVE_BRICK_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WILL_O_WISP, MOVE_DISCHARGE, MOVE_NIGHT_SHADE, MOVE_THIEF}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_DOUBLE_SHOCK, MOVE_REVIVAL_BLESSING, MOVE_FAKE_OUT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BOOMBURST, MOVE_OVERDRIVE, MOVE_BELCH, MOVE_SHIFT_GEAR}
    }
};

static const struct TrainerMon sParty_Fluffy1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_TALONFLAME,
    .heldItem = ITEM_FLYING_GEM,
    .moves = {MOVE_ACROBATICS, MOVE_FLAME_CHARGE, MOVE_U_TURN, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAILWIND, MOVE_FLAMETHROWER, MOVE_BUG_BUZZ, MOVE_QUIVER_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_BURNING_JEALOUSY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_LAVA_PLUME, MOVE_SMOKESCREEN, MOVE_DOUBLE_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_PULSE, MOVE_DRAGON_DANCE, MOVE_HURRICANE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ARMOR_CANNON, MOVE_EXPANDING_FORCE, MOVE_MYSTICAL_FIRE, MOVE_CLEAR_SMOG}
    }
};

static const struct TrainerMon sParty_Val1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,    
    ...
    .isShiny = TRUE,
    .heldItem = ITEM_NONE,   
    .moves = {MOVE_FOUL_PLAY, MOVE_U_TURN, MOVE_KNOCK_OFF, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER_FANG, MOVE_FIRE_FANG, MOVE_EARTHQUAKE, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_FELL_STINGER, MOVE_CRUNCH, MOVE_VENOSHOCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NIGHT_SLASH, MOVE_BRAVE_BIRD, MOVE_CONFUSE_RAY, MOVE_HAZE}
    },
    {
    ...
    .lvl = 50,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KOWTOW_CLEAVE, MOVE_POISON_JAB, MOVE_SUCKER_PUNCH, MOVE_IRON_HEAD}
    },
    {
    .species = SPECIES_GRIMMSNARL,
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .moves = {MOVE_SPIRIT_BREAK, MOVE_FOUL_PLAY, MOVE_PARTING_SHOT, MOVE_DRAIN_PUNCH}
    }
};

static const struct TrainerMon sParty_Duckie1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_STONE_EDGE, MOVE_BRICK_BREAK, MOVE_IRON_HEAD, MOVE_NIGHT_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_ROAR, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AURA_SPHERE, MOVE_METAL_CLAW, MOVE_QUICK_ATTACK, MOVE_SCREECH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_BRICK_BREAK, MOVE_IRON_HEAD, MOVE_SWORDS_DANCE, MOVE_X_SCISSOR}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METAL_BURST, MOVE_EARTHQUAKE, MOVE_SMACK_DOWN, MOVE_BODY_PRESS}
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGATON_HAMMER, MOVE_FAKE_OUT, MOVE_PLAY_ROUGH, MOVE_STONE_EDGE}
    }
};

static const struct TrainerMon sParty_Moshi1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_RUNERIGUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_EARTHQUAKE, MOVE_CURSE, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSE_RAY, MOVE_TOXIC, MOVE_SHADOW_BALL, MOVE_VENOSHOCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_BONEMERANG, MOVE_SHADOW_BONE, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PLAY_ROUGH, MOVE_SHADOW_CLAW, MOVE_SHADOW_SNEAK, MOVE_CURSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY, MOVE_SHADOW_BALL, MOVE_FROST_BREATH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_SUCKER_PUNCH, MOVE_SHADOW_SNEAK, MOVE_METRONOME}
    }
};

static const struct TrainerMon sParty_Meep1[] = {
    ...
    .moves = {MOVE_GRASSY_TERRAIN, MOVE_GIGA_DRAIN,MOVE_LEECH_SEED , MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_TOXIC, MOVE_GIGA_DRAIN, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAILWIND, MOVE_LEECH_SEED, MOVE_MOONBLAST, MOVE_ENERGY_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCIENT_POWER, MOVE_BRINE, MOVE_GIGA_DRAIN, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_DIG, MOVE_X_SCISSOR, MOVE_LEECH_SEED}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCIENT_POWER, MOVE_GRASSY_GLIDE, MOVE_IRON_TAIL, MOVE_MAGICAL_LEAF}
    }


};

static const struct TrainerMon sParty_Mocha1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OUTRAGE, MOVE_LIGHT_SCREEN, MOVE_EXTRASENSORY, MOVE_GLARE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CURSE, MOVE_U_TURN, MOVE_BITTER_MALICE, MOVE_SNARL}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SMELLING_SALTS, MOVE_THUNDER_WAVE, MOVE_PARABOLIC_CHARGE, MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .gender = TRAINER_MON_FEMALE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CALM_MIND, MOVE_STORED_POWER, MOVE_FAKE_OUT, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_SUCKER_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_AERIAL_ACE, MOVE_SKY_ATTACK, MOVE_METAL_CLAW, MOVE_CLOSE_COMBAT}
    }

};

static const struct TrainerMon sParty_Latte1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_CRAMORANT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FEATHER_DANCE, MOVE_WHIRLPOOL, MOVE_SURF, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_PULSE, MOVE_WATER_PULSE, MOVE_AURA_SPHERE, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MUDDY_WATER, MOVE_EARTH_POWER, MOVE_ANCIENT_POWER, MOVE_SLUDGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_ICE_FANG, MOVE_AQUA_JET, MOVE_LIQUIDATION, MOVE_CRUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .isShiny = TRUE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_HAIL, MOVE_BRINE, MOVE_BLIZZARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AQUA_STEP, MOVE_CLOSE_COMBAT, MOVE_AQUA_JET, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMon sParty_Jane[] = {
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 27,
...
static const struct TrainerMon sParty_Moon1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_BISHARP,
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_SUCKER_PUNCH, MOVE_IRON_HEAD, MOVE_NIGHT_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_BUG_BUZZ, MOVE_PSYBEAM}
    },
};
static const struct TrainerMon sParty_Vi1[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_IRON_VALIANT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPIRIT_BREAK, MOVE_CLOSE_COMBAT, MOVE_PSYCHO_CUT, MOVE_SWORDS_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .gender = TRAINER_MON_FEMALE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_PSYCHIC, MOVE_MYSTICAL_FIRE, MOVE_PSYCHIC_TERRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .gender = TRAINER_MON_FEMALE,   
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_FAKE_OUT, MOVE_SHADOW_BALL, MOVE_ROCK_TOMB}
    },
};

static const struct TrainerMon sParty_Vi2[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    .species = SPECIES_IRON_VALIANT,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DISCHARGE, MOVE_RAIN_DANCE, MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_METEOR_MASH, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE}
    },
};
...
static const struct TrainerMon sParty_Melia[] = {
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .isShiny = TRUE,
    .nickname = COMPOUND_STRING("Patience"),
    ...
    .heldItem = ITEM_NONE,
    .isShiny = TRUE,
    .nickname = COMPOUND_STRING("Fortitude"),
    .moves = {MOVE_DARK_PULSE, MOVE_SLUDGE_BOMB, MOVE_FLAMETHROWER, MOVE_NASTY_PLOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .isShiny = TRUE,
    .nickname = COMPOUND_STRING("Serenity"),
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_GIGA_DRAIN, MOVE_STOMPING_TANTRUM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .isShiny = TRUE,
    .nickname = COMPOUND_STRING("Hapi"),
    .moves = {MOVE_AURA_SPHERE, MOVE_AIR_SLASH, MOVE_ROOST, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .isShiny = TRUE,
    .nickname = COMPOUND_STRING("Peace"),
    .moves = {MOVE_PLAY_ROUGH, MOVE_WATERFALL, MOVE_SUPERPOWER, MOVE_AQUA_JET}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .isShiny = TRUE,
    .nickname = COMPOUND_STRING("Unity"),
    .moves = {MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_DRAGON_PULSE, MOVE_ROOST}
    }
};
