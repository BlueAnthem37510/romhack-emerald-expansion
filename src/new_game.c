...
static void SetUpPokemon(void){
    ...
    //GiveMonToPlayer(&mon);
    CreateMonsFromTrainerNum(TRAINER_ICHI);
    CreateMonsFromTrainerNum(TRAINER_HEEB);
    CreateMonsFromTrainerNum(TRAINER_FIZZY);
    CreateMonsFromTrainerNum(TRAINER_ANNA);
    CreateMonsFromTrainerNum(TRAINER_DUCKIE);
    CreateMonsFromTrainerNum(TRAINER_MEEP);
    CreateMonsFromTrainerNum(TRAINER_MOCHA);
    CreateMonsFromTrainerNum(TRAINER_LATTE);
